...
import sports_scraper  # ייבוא הקובץ הנפרד של אתרי הספורט
...
async def sports_news(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # קריאה לפונקציות מ-sports_scraper.py
    sport5_news, sport5_error = sports_scraper.scrape_sport5()
    sport1_news, sport1_error = sports_scraper.scrape_sport1()
    one_news, one_error = sports_scraper.scrape_one()
